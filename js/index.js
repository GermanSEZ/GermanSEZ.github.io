...
checkout.addEventListener('click', emptyCart, Cartempty)
...
const renderCards = async (productsArr) => {
    ...
    <div class="row row-cols-2">
      <img src=${product.data().img} class="card-img-top productImg img-responsive" alt=${product.data().name}>
